...
class TareasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarea" do
    assert_difference("Tarea.count") do
      post tareas_url, params: { tarea: { completado: @tarea.completado, descripcion: @tarea.descripcion, titulo: @tarea.titulo, usuario_id: @tarea.usuario_id } }
    end
  ...
  test "should update tarea" do
    patch tarea_url(@tarea), params: { tarea: { completado: @tarea.completado, descripcion: @tarea.descripcion, titulo: @tarea.titulo, usuario_id: @tarea.usuario_id } }
